...
class PlacesTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        lbNoPlaces = UILabel()
        lbNoPlaces.text = "Choose the places you would like to know pressing the button +"
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        if places.count > 0 {
            let btShowAll = UIBarButtonItem(title: "Show all on map", style: .plain, target: self, action: #selector(showAll))
